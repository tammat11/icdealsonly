        ...
        <section ref={root} className="relative h-screen min-h-[100dvh] flex flex-col items-center justify-center pt-10 pb-10 px-6 overflow-hidden bg-white">
            ...
            <div className="max-w-7xl mx-auto text-center relative z-10 w-full flex flex-col items-center">
                ...
                <h1 className="flex flex-col items-center mb-6 select-none font-extrabold tracking-tighter uppercase whitespace-nowrap leading-[0.8] relative z-10">
                    <span className="block text-[clamp(42px,12vw,120px)] text-brand-dark animate-title-reveal" style={{ animationDelay: '0.4s' }}>
                        Создать
                    </span>
                    <span className="block text-[clamp(48px,14vw,140px)] text-brand-green relative inline-block px-4 py-1 overflow-visible group animate-title-reveal" style={{ animationDelay: '0.5s' }}>
                        ...
                        <div className="absolute top-1/2 right-[-10%] -translate-x-1/2 -translate-y-1/2 w-16 h-16 md:w-28 md:h-28 pointer-events-none z-10 opacity-40 flex items-center justify-center mix-blend-multiply animate-cleaner-dirt">
                        ...
                        {/* ✨ The Clean Sparkle */}
                        <div className="absolute top-0 right-0 w-24 h-24 pointer-events-none z-[50] opacity-0 flex items-center justify-center animate-cleaner-sparkle">
                        ...
                        <img
                            src="/rag.png"
                            alt="Cleaning"
                            className="absolute top-0 right-[-20%] w-40 md:w-64 h-auto pointer-events-none z-[60] opacity-0 animate-cleaner-hand"
                        />
                    </span>
                    <span className="block text-[clamp(42px,12vw,120px)] text-brand-dark animate-title-reveal" style={{ animationDelay: '0.6s' }}>
                        Во всем
                    </span>
                </h1>

                <div className="max-w-2xl mb-6 animate-fade-in" style={{ animationDelay: '0.8s' }}>
                ...
                <div className="flex flex-col items-center gap-6 animate-fade-in" style={{ animationDelay: '1s' }}>
                    <button
                        onClick={onCalcOpen}
