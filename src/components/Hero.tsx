        ...
        <section ref={root} className="relative h-screen min-h-[100dvh] flex flex-col items-center justify-center pt-10 pb-10 px-6 overflow-hidden bg-white">
            ...
            <div className="max-w-7xl mx-auto text-center relative z-10 w-full flex flex-col items-center">
                ...
                <h1 className="flex flex-col items-center mb-6 select-none font-extrabold tracking-tighter uppercase whitespace-nowrap leading-[0.8] relative z-20">
                    <span className="on-reveal stagger-1 block text-[clamp(42px,12vw,120px)] text-brand-dark">
                        Создать
                    </span>
                    <span className="on-reveal stagger-2 block text-[clamp(48px,14vw,140px)] text-brand-green relative inline-block px-4 py-1 overflow-visible group">
                        ...
                        <div className="absolute top-1/2 right-[-5%] -translate-y-1/2 w-[20%] h-full pointer-events-none z-[70]">
                            ...
                            {/* 🌫️ The Dirt Spot (Smaller) */}
                            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-12 md:w-20 h-12 md:h-20 animate-cleaner-dirt mix-blend-multiply opacity-0">
                            ...
                            {/* ✨ The Clean Sparkle (White with Green Glow) */}
                            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-24 h-24 opacity-0 flex items-center justify-center animate-cleaner-sparkle">
                            ...
                            {/* ✋ The Cleaning Cloth (Larger) */}
                            <img
                                src="/rag.png"
                                alt="Cleaning"
                                className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-56 md:w-96 h-auto opacity-0 animate-cleaner-hand"
                            />
                        </div>
                    </span>
                    <span className="on-reveal stagger-3 block text-[clamp(42px,12vw,120px)] text-brand-dark">
                        Во всем
                    </span>
                </h1>
                ...
                <div className="flex flex-col items-center gap-6 on-reveal stagger-5">
                    <button
                        onClick={onCalcOpen}
