            ...
            <div className="max-w-7xl mx-auto text-center relative z-10 w-full flex flex-col items-center">
                ...
                <h1 className="flex flex-col items-center mb-6 select-none font-extrabold tracking-tighter uppercase whitespace-nowrap leading-[0.8] relative z-20">
                    ...
                    <span className="on-reveal stagger-2 block text-[clamp(48px,14vw,140px)] text-brand-green relative inline-block px-4 py-1 overflow-visible group">
                        ...
                        <div className="absolute top-1/2 right-[-10%] -translate-x-1/2 -translate-y-1/2 w-16 h-16 md:w-28 md:h-28 pointer-events-none z-10 animate-cleaner-dirt mix-blend-multiply">
                        ...
                        {/* ✨ The Clean Sparkle */}
                        <div className="absolute top-0 right-1/4 w-24 h-24 pointer-events-none z-[50] opacity-0 flex items-center justify-center animate-cleaner-sparkle">
                        ...
                        <img
                            src="/rag.png"
                            alt="Cleaning"
                            className="absolute top-0 right-[-30%] w-40 md:w-64 h-auto pointer-events-none z-[60] opacity-0 animate-cleaner-hand"
                        />
                    </span>
                ...
                <div className="max-w-2xl mb-8 on-reveal stagger-4">
