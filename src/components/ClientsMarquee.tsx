        ...
        <section className="py-20 bg-white border-y border-black/5 overflow-hidden">
            <div className="max-w-7xl mx-auto px-6 mb-12 on-reveal">
                <div className="flex items-center gap-6">
                    <span className="text-[12px] font-bold uppercase tracking-[0.3em] text-brand-dark/30 whitespace-nowrap">Наши ключевые партнеры</span>
                        ...
                        <div key={set} className="flex items-center gap-8 md:gap-24">
                            {clients.map((client, i) => (
                                ...
                                >
                                            ...
                                            onError={(e) => {
                                                ...
                                                if (!target.src.includes('google.com')) {
                                                    ...
                                                    if (parent) {
                                                        ...
                                                        parent.innerHTML = `<span class="text-xl font-bold text-brand-dark/20">${initials}</span>`;
                                                    }
                                                }
                                            }}
                                        />
                                    ...
                                    <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-brand-dark/20 group-hover:text-brand-green transition-colors duration-500">
                                        {client.name}
                                    </span>
                                </div>
                            ))}
